...
<div id="lightbox" class="fixed inset-0 hidden z-50 bg-black/80">
  ...
  <div class="h-full w-full grid grid-rows-[1fr_auto_auto] place-items-center p-4">
    ...
    <div class="mt-3 flex items-center gap-3">
      <button id="lbPrev" class="rounded-lg bg-white/10 px-3 py-2 text-white hover:bg-white/20">← Anterior</button>
      <button id="lbNext" class="rounded-lg bg-white/10 px-3 py-2 text-white hover:bg-white/20">Siguiente →</button>
